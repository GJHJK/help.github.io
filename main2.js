...
$(document).ready(function () {
    ...
    // onclick
    $("#basic-addon2").on("click", filter);

    $("#butsave").on("click", function () {
        $("#butsave").attr("disabled", "disabled");
        var id = document.forms["frm2"]["Pcommentid"].value;
        var msg = document.forms["frm2"]["msg"].value;
        if (msg != "") {
            $.ajax({
                url: "save2.php",
                type: "POST",
                ...
                success: function (dataResult) {
                    ...
                    if (dataResult.statusCode == 200) {
                        ...
                        document.forms["frm2"]["Pcommentid"].value = "";
                        document.forms["frm2"]["msg"].value = "";
                        filter();
